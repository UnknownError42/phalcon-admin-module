...
use Gazlab\Admin\Models\GazlabProfiles as Profiles;
...
class Acl extends Component
{
    ...
    public function isPrivate($controllerName, $actionName)
    {
        ...
        return isset($this->privateResources[$controllerName]) && in_array($actionName, $this->privateResources[$controllerName]);
    }
    ...
    public function rebuild()
    {
        ...
        foreach ($profiles as $profile) {
            ...
            $acl->allow($profile->name, 'administrators', 'profile');
            $acl->allow($profile->name, 'administrators', 'deleteAccount');
            $acl->allow($profile->name, 'sessions', 'signOut');
            $acl->allow($profile->name, 'index', 'error');
        }
    ...
    {
        @mkdir(rtrim($this->config->application->cacheDir, '\\/') . '/acl');
